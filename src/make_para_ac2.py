...
def make_gaussview_xyz(auto_dir,monomer_name,params_dict,machine_type,isInterlayer=False):
    ...
    monomer_array_i = get_monomer_xyzR3(monomer_name,0,0,0,A1,A2,A3, phi1)
    
    monomer_array_p1 = get_monomer_xyzR3(monomer_name,0,b_,0,A1,A2,A3, phi1)##1,2がb方向
    monomer_array_p2 = get_monomer_xyzR3(monomer_name,0,-b_,0,A1,A2,A3, phi1)
    ...
    monomer_array_p3 = get_monomer_xyzR3(monomer_name,a_,0,0,A1,A2,A3, phi1)##3,4がa方向
    monomer_array_p4 = get_monomer_xyzR3(monomer_name,-a_,0,0,A1,A2,A3, phi1)
    ...
    monomer_array_t1 = get_monomer_xyzR4(monomer_name,a_/2,b_/2,0,-A1,A2,-A3, phi2)
    monomer_array_t2 = get_monomer_xyzR4(monomer_name,a_/2,-b_/2,0,-A1,A2,-A3, phi2)
    monomer_array_t3 = get_monomer_xyzR4(monomer_name,-a_/2,-b_/2,0,-A1,A2,-A3, phi2)
    monomer_array_t4 = get_monomer_xyzR4(monomer_name,-a_/2,b_/2,0,-A1,A2,-A3, phi2)
...
def make_gjf_xyz(auto_dir,monomer_name,params_dict,machine_type,isInterlayer):##R3:t-shaped R4:slipped-parallel
    ...
    monomer_array_c1 = get_monomer_xyzR3(monomer_name,0,0,0,A1,A2,A3, phi1)##centerのc
    
    if a_ > b_:
        monomer_array_p1 = get_monomer_xyzR3(monomer_name,0,b_,R4,A1,A2,A3, phi1)##p1がb方向
        monomer_array_p2 = get_monomer_xyzR3(monomer_name,0,-b_,R4,A1,A2,A3, phi1)#
        monomer_array_ip1 = get_monomer_xyzR3_(monomer_name,c[0],c[1]+b_,c[2]+R4,A1,A2,A3, phi1)
        monomer_array_ip2 = get_monomer_xyzR3_(monomer_name,c[0],c[1]-b_,c[2]-R4,A1,A2,A3, phi1)
    else:##a_<b_
        monomer_array_p1 = get_monomer_xyzR3(monomer_name,a_,0,2*R3-R4,0,0,A3, phi1)##p2がa方向
        monomer_array_p2 = get_monomer_xyzR3(monomer_name,-a_,0,2*R3-R4,0,0,A3, phi1)
        monomer_array_ip1 = get_monomer_xyzR3_(monomer_name,c[0]+a_,c[1],c[2]+2*R3-R4,A1,A2,A3, phi1)
        monomer_array_ip2 = get_monomer_xyzR3_(monomer_name,c[0]-a_,c[1],c[2]-(2*R3-R4),A1,A2,A3, phi1)
    
    monomer_array_c2 = get_monomer_xyzR4(monomer_name,0,0,0,-A1,A2,-A3, phi1)##centerのc 角度-A3
    monomer_array_i02 = get_monomer_xyzR4_(monomer_name,c[0],c[1],c[2],-A1,A2,-A3, phi2)
    if a_ > b_:
        monomer_array_p3 = get_monomer_xyzR4(monomer_name,0,b_,0,-A1,A2,-A3, phi1)
        monomer_array_p4 = get_monomer_xyzR4(monomer_name,0,-b_,0,-A1,A2,-A3, phi1)
        monomer_array_ip3 = get_monomer_xyzR4_(monomer_name,c[0],c[1]+b_,c[2]+R4,-A1,A2,-A3, phi2)
        monomer_array_ip4 = get_monomer_xyzR4_(monomer_name,c[0],c[1]-b_,c[2]-R4,-A1,A2,-A3, phi2)
    else:
        monomer_array_p3 = get_monomer_xyzR4(monomer_name,a_,0,0,-A1,A2,-A3, phi1)
        monomer_array_p4 = get_monomer_xyzR4(monomer_name,-a_,0,0,-A1,A2,-A3, phi1)
        monomer_array_ip3 = get_monomer_xyzR4_(monomer_name,c[0]+a_,c[1],c[2]+2*R3-R4,-A1,A2,-A3, phi2)
        monomer_array_ip4 = get_monomer_xyzR4_(monomer_name,c[0]-a_,c[1],c[2]-(2*R3-R4),-A1,A2,-A3, phi2)

    monomer_array_i01 = get_monomer_xyzR3_(monomer_name,c[0],c[1],c[2],A1,A2,A3, phi1)
    monomer_array_t1 = get_monomer_xyzR4(monomer_name,a_/2,b_/2,R3,-A1,A2,-A3, phi2)
    monomer_array_t2 = get_monomer_xyzR4(monomer_name,a_/2,-b_/2,R3-R4,-A1,A2,-A3, phi2)
    monomer_array_t3 = get_monomer_xyzR4(monomer_name,-a_/2,-b_/2,-R3,-A1,A2,-A3, phi2)
    monomer_array_t4 = get_monomer_xyzR4(monomer_name,-a_/2,b_/2,-R3+R4,-A1,A2,-A3, phi2)
    monomer_array_it1 = get_monomer_xyzR4_(monomer_name,c[0]+a_/2,c[1]+b_/2,c[2]+R3,-A1,A2,-A3, phi2)
    monomer_array_it2 = get_monomer_xyzR4_(monomer_name,c[0]+a_/2,c[1]-b_/2,c[2]+R3-R4,-A1,A2,-A3, phi2)
    monomer_array_it3 = get_monomer_xyzR4_(monomer_name,c[0]-a_/2,c[1]-b_/2,c[2]-R3,-A1,A2,-A3, phi2)
    monomer_array_it4 = get_monomer_xyzR4_(monomer_name,c[0]-a_/2,c[1]+b_/2,c[2]-R3+R4,-A1,A2,-A3, phi2)
    ...
    dimer_array_it3 = np.concatenate([monomer_array_i01,monomer_array_t3])
    dimer_array_it4 = np.concatenate([monomer_array_i01,monomer_array_t4])
    ...
    dimer_array_ip3 = np.concatenate([monomer_array_i02,monomer_array_p3])##注意
    dimer_array_ip4 = np.concatenate([monomer_array_i02,monomer_array_p4])##注意
